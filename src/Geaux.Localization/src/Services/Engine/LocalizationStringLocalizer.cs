...
/// </summary>
public sealed class LocalizationStringLocalizer : IStringLocalizer
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LocalizationStringLocalizer"/> class.
    /// </summary>
    ...
    public LocalizationStringLocalizer(
    ...
    public IEnumerable<LocalizedString> GetAllStrings(bool includeParentCultures)
    {
        ...
        List<LocalizedString> resolved = rows
            .GroupBy(x => x.Key)
            .Select(g =>
    ...
    /// <summary>
    /// Creates a new <see cref="LocalizationStringLocalizer"/> scoped to the provided culture.
    /// </summary>
    /// <param name="culture">The culture to apply.</param>
    /// <returns>A localizer configured for the given culture.</returns>
    public LocalizationStringLocalizer WithCulture(CultureInfo culture)
        => new(_dbFactory,
    ...
    /// <summary>
    /// Creates a new <see cref="LocalizationStringLocalizer"/> scoped to the provided tenant.
    /// </summary>
    ...
    public LocalizationStringLocalizer WithTenant(string? tenantId)
        => new(_dbFactory,
               Microsoft.Extensions.Options.Options.Create(_options),
               _resourceName,
