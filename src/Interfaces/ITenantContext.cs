...
namespace Geaux.Localization.Interfaces
{
    ...
    public interface ITenantContext
    {
        ...
        /// </summary>
        /// <remarks>Use this property to determine which tenant is currently active in multi-tenant
        /// scenarios. The value may be null or empty if no tenant context is set.</remarks>
